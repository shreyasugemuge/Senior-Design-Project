		...
		\begin{enumerate}[label* = .\arabic*, itemsep=-1mm]
			...
			\begin{enumerate}[label* = .\arabic*, itemsep=-1mm]
				...
				\begin{enumerate}[label* = .\arabic*, itemsep=-1mm]
					...
					\item Button to correlate behaviors and performance
					\item Shall present a report of the correlations found in behaviors and performance for the class
					\item Shall present information showing successful behavior for a query student
				\end{enumerate}
				\item Student interface
				\begin{enumerate}[label* = .\arabic*, itemsep=-1mm]
					\item Shall be able to access recommendations
					\item Recommendations will provide performance information and behaviors that are recommended to be altered in order to gain higher grades.
				\end{enumerate}
			\end{enumerate}
			\item Security Requirements
			\begin{enumerate}[label* = .\arabic*, itemsep=-1mm]
				\item System shall isolate log file from public networks
				\item System shall isolate grade file from public networks
			\end{enumerate}
		\end{enumerate}
	\end{enumerate}
	\end{document}

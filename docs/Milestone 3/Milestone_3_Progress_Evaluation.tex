...
%After locating all ASR Units, I located the date each of them was submitted.  I compared the submission date of each ASR Unit with the deadline for each Unit, which was the last day the Unit Tests were available (checked manually). I, then, calculated the total number of ASR Units submitted after the deadline. 
